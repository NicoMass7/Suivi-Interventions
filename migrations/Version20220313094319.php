 ...
 */
final class Version20220313094319 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rh (id INT AUTO_INCREMENT NOT NULL, nom_rh VARCHAR(255) NOT NULL, prenom_rh VARCHAR(255) NOT NULL, mail_rh VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
