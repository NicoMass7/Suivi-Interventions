 ...
 */
final class Version20220313085105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE astreinte (id INT AUTO_INCREMENT NOT NULL, categorie VARCHAR(255) NOT NULL, demi_journee INT NOT NULL, journee INT NOT NULL, nuit INT NOT NULL, ferie INT NOT NULL, week_end INT NOT NULL, semaine INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
